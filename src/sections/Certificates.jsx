...
const certificates = [
  ...
  // ── Achievements ──
  {
    id: 10,
    type: "achievement",
    title: "FLAMES'25 Hackathon – Top Finalist",
    issuer: "W3Grads",
    date: "2025",
    icon: "🏆",
    color: "#f59e0b",
  ...
  },
  {
    id: 11,
    type: "achievement",
    title: "Agile Sprint Delivery – 20% Team Efficiency Boost",
    issuer: "W3Grads Internship",
    date: "2025",
    icon: "⚡",
    color: "#10b981",
    link: "#",
  ...
  },
  {
    id: 12,
    type: "achievement",
    title: "Full-Stack Project Delivered On Time",
    issuer: "MERN + GenAI Training",
    date: "2025",
    icon: "🎯",
    color: "#8b5cf6",
    link: "#",
